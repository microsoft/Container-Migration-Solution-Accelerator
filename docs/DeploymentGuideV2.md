...
5. Click **View my access** button
6. Review your assigned roles - you should see:
   - **Contributor** 
...
> **Finding Tenant ID:** Go to [Azure Portal](https://portal.azure.com/) → Azure Active Directory → Overview → Tenant ID
