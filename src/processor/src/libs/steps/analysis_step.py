    ...
    async def execute_analysis(
        ...
        try:
            ...
            **📚 MICROSOFT DOCS STRATEGIC RESEARCH**:
            ...
            - SEARCH first for discovery: "EKS to AKS migration", "Kubernetes Azure compatibility"
            - FETCH complete guides from search results for detailed Azure specifications
            - Essential for platform compatibility validation and Azure service mapping
            ...
            **DETAILED DELIVERABLES**:
            1. **Complete File Discovery**: Catalog all YAML, YML and configuration files with metadata
