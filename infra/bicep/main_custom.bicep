...
module userOpenAiRoleAssignment './modules/identity/role.bicep' = if (!useExistingAiFoundryAiProject) {
...
module userOpenAiRoleAssignmentExisting './modules/identity/role.bicep' = if (useExistingAiFoundryAiProject) {
