...
module existingAiFoundryAiServicesDeployments './modules/ai/ai-services-deployments.bicep' = if (useExistingAiFoundryAiProject) {
...
// ========== AI Foundry Project ========== //
module aiFoundryProject './modules/ai/ai-project.bicep' = if (!useExistingAiFoundryAiProject) {
